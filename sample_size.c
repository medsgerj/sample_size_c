...
float confidence_level_constant[5][2] = {{50, .67},{68, .99},{90, 1.64}, {95, 1.96}, {99, 2.57}};

/* CALCUALTE THE SAMPLE SIZE */
int sample_size(long long population_size, float confidence_level, float confidence_interval)
{
  float Z; /* Z SCORE */
  float p; /* VARIANCE */
  float e; /* ERROR */
